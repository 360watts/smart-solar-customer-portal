...
export function JourneySection() {
  ...
  if (!enabled) {
    // Static fallback: mobile + reduced-motion. Same content, plain stacked cards.
    return (
      <section className="px-4 sm:px-6 py-16 bg-[#0c1e14]">
  ...
  return (
    <section
      ref={sectionRef}
      className="relative h-screen overflow-hidden bg-[#0c1e14]"
    ...
    >
      ...
      <div
        ref={sunRef}
        className="absolute top-1/2 z-10 -translate-x-1/2 pointer-events-none"
        style={{ left: "0%" }}
      >
